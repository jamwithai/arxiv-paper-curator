...
from src.services.drafting.factory import make_drafting_service
...
def get_drafting_service(
    ...
    """Get citation-grounded drafting service (Stage 3)."""
    return make_drafting_service(
        opensearch_client=opensearch,
        llm_client=llm,
        embeddings_client=embeddings,
        settings=settings,
...
DraftingDep = Annotated[DraftingService, Depends(get_drafting_service)]
